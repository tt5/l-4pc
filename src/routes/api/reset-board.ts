...
export const POST = withAuth(async ({ user }) => {
  ...
  try {
    ...
    await repository.add(user.userId, 5, 0, '#FFEB3B', 'bishop'); // Yellow Bishop
    ...
    await repository.add(user.userId, 8, 13, '#F44336', 'bishop');// Red Bishop
    ...
    await repository.add(user.userId, 0, 8, '#2196F3', 'bishop'); // Blue Bishop
    ...
    await repository.add(user.userId, 13, 5, '#4CAF50', 'bishop');// Green Bishop
    ...
    return createApiResponse(
      { 
        ...
        basePoints: [
          ...
          { x: 5, y: 0, pieceType: 'bishop', color: '#FFEB3B' }, // Yellow Bishop
          ...
          { x: 8, y: 13, pieceType: 'bishop', color: '#F44336' },// Red Bishop
          ...
          { x: 0, y: 8, pieceType: 'bishop', color: '#2196F3' }, // Blue Bishop
          ...
          { x: 13, y: 5, pieceType: 'bishop', color: '#4CAF50' },// Green Bishop
